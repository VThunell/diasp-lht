...
and European eel LHTs (T2.1.1) and identify gaps in the current DCF and make recommendations for improvements in data collection based on assessment model needs.
...
diadrom.DCF.22 %>%
  ...
  labs(title = "Achieved number of individuals sampled at national level", subtitle = "Table 2.2. & 1C - biological variables")
```
...
diadrom.DCF.23.clean %>%
  ...
  theme(axis.text.x = element_text(angle = 90),
        axis.text = element_text(size=6)) +
    labs(title = "Achieved number of units measured at national level", subtitle = "Table 2.3. & 1E  - Diadromous")
...
diadrom.DCF.23.clean %>%
  ...
  theme(axis.text.x = element_text(angle = 90),
        axis.text = element_text(size=6)) +
    labs(title = "Eel achieved number of units measured at national level", subtitle = "Table 2.3. & 1E  - Diadromous")
...
diadrom.DCF.23.clean %>%
  ...
  theme(axis.text.x = element_text(angle = 90),
        axis.text = element_text(size=6)) +
    labs(title = "Salmon achieved number of units measured at national level", subtitle = "Table 2.3. & 1E  - Diadromous")
