...
biph0.samples <- runMCMC(biph0.mcmcc, niter = 2500000, nburnin = 2475000, nchains = 2, thin=10, samplesAsCodaMCMC = TRUE)
#biph11.samples <- runMCMC(biph11.mcmcc, niter = 200000, nburnin = 185000, thin=10)#, WAIC=TRUE) 
#Sys.time() - t
#gc()

saveRDS(biph0.samples, file = paste0(home,"/data/biph0_samples_1121.RData"))
